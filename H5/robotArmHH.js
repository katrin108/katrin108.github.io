     ...
     window.addEventListener("keydown", function(e){
         switch( e.keyCode ) {
            ...
            case 81:	// q - snýr efri armi
			    theta[2] = Math.min(100, theta[2]+5);
                break;
            case 87:	// w - snýr efri armi
			    theta[2] = Math.max(-100, theta[2]-5);
                break;
            case 49:	// 1 - snýr hendi
			    theta[3] = Math.min(100, theta[3]+5);
                console.log(theta[3]);
                break;
            case 50:	// 2 - snýr hendi
			    theta[3] = Math.max(-100, theta[3]-5);
                break;
...
var render = function() {
    ...
    modelViewMatrix  = mult(modelViewMatrix, translate(0.0, HAND_HEIGHT, 0.0));
