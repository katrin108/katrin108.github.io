...
//viðbætur fyrir verkefni 6 Katrín okt 2025
/////////////////////////////////////////////////////////////////
var canvas;
var gl;
...
//    gl.cullFace(gl.BACK);
    ...
    // Event listener for mousewheel
     ...
     //get the slider 
     const blinnPhongcheckbox = this.document.getElementById('blinn-phong');
     const useBlinnPhong = gl.getUniformLocation(program,'useblinn'); 
     
     const PhongText = this.document.getElementById('phong_Text');
     gl.uniform1f(useBlinnPhong,blinnPhongcheckbox.checked);
     window.addEventListener('change',function(e){
        gl.uniform1f(useBlinnPhong,blinnPhongcheckbox.checked);
        PhongText.innerText=blinnPhongcheckbox.checked?"Blinn-Phong":"Phong";
     })
